######################
# azure-quota-request.ps1 #
######################
# Version: 1.4
# Last Modified: 2/16/2022
# Author: Xavier Elizondo 
# Contributors: Nick Thomas

# BEWARE: THIS SCRIPT IS PROVIDED WITH NO WARRANTIES AND HAS NOT BEEN FULLY TESTED.

<#
.SYNOPSIS
Quries for existing quota for a VM SKU and creates a support if neededFully resets an AAD tenant after deploying Enterprise Scale (Azure Landing Zone Accelerator) so it can be deployed again.

.DESCRIPTION
Retried the .

.EXAMPLE
.\az-quota-request.ps1 

.NOTES
https://learn.microsoft.com/rest/api/support/
https://learn.microsoft.com/powershell/module/az.support/

#>

#Fill out parameters per your requirements
...
#Validate if quota reaches threshold
...
Referecence information for Service GUIDs 
...
Referecence information for Problem Classification GUIDs 
